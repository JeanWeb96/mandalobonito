...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-30 w-64 bg-gray-900 text-white flex flex-col transition-transform duration-200 lg:static lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
          ...
          <div className="min-w-0">
            <p className="font-bold text-sm leading-tight truncate">Mándalo Bonito</p>
        ...
        <div className="px-3 pb-4 border-t border-white/10 pt-4">
          <a
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:bg-white/10 hover:text-white transition-colors mb-1"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
